...
import com.sam_chordas.android.stockhawk.touch_helper.RecyclerViewItemClickListener;
import com.sam_chordas.android.stockhawk.rest.Utils;
import com.sam_chordas.android.stockhawk.rest.StockIntentService;
import com.sam_chordas.android.stockhawk.rest.StockTaskService;
...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void networkToast() {
        Toast.makeText(context, R.string.network_issue, Toast.LENGTH_SHORT).show();
    }
